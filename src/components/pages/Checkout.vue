    ...
    <div class="app-container">
        ...
        <div class="checkout-content">
            <div class="details">
                ...
                @input-change="firstNameChange"/>
                
                <DetailsInput
                forValue="lastName"
                label="Last name"
                placeholder="Your last name"
                @input-change="lastNameChange"/>
            </div>
            <div class="delivery">
                <h2>Delivery</h2>
                ...
                <div class="date-picker">
                    <Datepicker
                    wrapper-class="calendar-container"
...
import { DisabledDates } from '../../interfaces/DisabledDates'
    ...
    get disabledDates() {
        ...
        this.cart.forEach(item => {
            switch (item.name) {
                ...
                case 'Fanta':
                    disabled.ranges = [{
                        from: new Date(2021, 2, 8),
                        to: new Date(2021, 2, 14)
                    }]
                    break;
                case 'Finley Ginger Ale':
                    disabled.from = new Date(2021, 3, 1)
                    break;
            }
        })
        const yesterday = new Date()                         
        yesterday.setDate(yesterday.getDate() - 1)
        disabled.to = yesterday
        return disabled
    }
}
</script>